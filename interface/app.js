...
(function () {
  function runApp() {
    ...
    var SKILL_BILUO_SVG = svg.SKILL_BILUO_SVG || '';
    var SKILL_TALANGXINGGE_SVG = svg.SKILL_TALANGXINGGE_SVG || '';
    var SKILL_XIANGRUIPUYOU_SVG = svg.SKILL_XIANGRUIPUYOU_SVG || '';
    ...
    function initBattle() {
      ...
      if (typeof window.BattleGrid !== 'undefined' && window.BattleGrid.initBattle) {
        window.BattleGrid.initBattle({
          ...
          SKILL_BILUO_SVG: SKILL_BILUO_SVG,
          SKILL_TALANGXINGGE_SVG: SKILL_TALANGXINGGE_SVG,
          SKILL_XIANGRUIPUYOU_SVG: SKILL_XIANGRUIPUYOU_SVG,
